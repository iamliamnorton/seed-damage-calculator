...
pdf.text t('.title'), :size => 20, :style => :bold, :align => :center
pdf.move_down(30)
if @calculator.valid?
...
[t('.phosphorus'), @calculator.phosphorus.to_s],
[t('.potassium'), @calculator.potassium.to_s],
[t('.sulphur'), @calculator.sulphur.to_s],
[t('.magnesium'), @calculator.magnesium.to_s]
]

pdf.text "Input", :size => 15, :style => :bold
pdf.move_down(5)
pdf.table(input_data)

pdf.move_down(30)

pdf.text "Output", :size => 15, :style => :bold
pdf.move_down(5)
...
pdf.move_down(10)
pdf.text "<u><link>seed-damage-calculator.herokuapp.com</link></u>", :align => :center, :inline_format => true
