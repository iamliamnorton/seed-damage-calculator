...
twentyeight = Fertiliser.create(:name => "28-0-0", :N => 0.28, :kgL => 1.276151)
amnit = Fertiliser.create(:name => "Am.Nit (34-0-0)", :N => 0.34)
dap = Fertiliser.create(:name => "DAP (18-46-0)", :N => 0.18, :P => 0.46)
map = Fertiliser.create(:name => "MAP (11-55-0)", :N => 0.11, :P => 0.55)
tsp = Fertiliser.create(:name => "TSP (0-46-0)", :P => 0.46)
ten = Fertiliser.create(:name => "10-34-0", :N => 0.1, :P => 0.34, :kgL => 1.389987)
seven = Fertiliser.create(:name => "7-21-7", :N => 0.07, :P => 0.21, :K => 0.07, :kgL => 1.282143)
nine = Fertiliser.create(:name => "9-18-9", :N => 0.09, :P => 0.18, :K => 0.09, :kgL => 1.318091)
three = Fertiliser.create(:name => "3-18-18", :N => 0.03, :P => 0.18, :K => 0.18, :kgL => 1.401969)
four = Fertiliser.create(:name => "4-10-10", :N => 0.04, :P => 0.1, :K => 0.1, :kgL => 1.282143)
...
ats = Fertiliser.create(:name => "ATS", :N => 0.12, :S => 0.26, :kgL => 1.330073)
