...
twentyeight = Fertiliser.create(:metric_name => "UAN (28-0-0)", :imperial_name => "UAN (28-0-0)", :N => 0.28, :metric_weight => 1.27607, :imperial_weight => 10.65)
...
ten = Fertiliser.create(:metric_name => "APP (10-15-0)", :imperial_name => "APP (10-34-0)", :N => 0.1, :P => 0.34, :metric_weight => 1.38990, :imperial_weight => 11.60)
seven = Fertiliser.create(:metric_name => "7-9-6", :imperial_name => "7-21-7", :N => 0.07, :P => 0.21, :K => 0.07, :metric_weight => 1.28206, :imperial_weight => 10.70)
nine = Fertiliser.create(:metric_name => "9-8-7.5", :imperial_name => "9-18-9", :N => 0.09, :P => 0.18, :K => 0.09, :metric_weight => 1.31801, :imperial_weight => 11.00)
three = Fertiliser.create(:metric_name => "3-8-15", :imperial_name => "3-18-18", :N => 0.03, :P => 0.18, :K => 0.18, :metric_weight => 1.40188, :imperial_weight => 11.70)
four = Fertiliser.create(:metric_name => "4-4.4-8", :imperial_name => "4-10-10", :N => 0.04, :P => 0.1, :K => 0.1, :metric_weight => 1.28206, :imperial_weight => 10.70)
...
ats = Fertiliser.create(:metric_name => "ATS (12-0-0-26S)", :imperial_name => "ATS (12-0-0-26S)", :N => 0.12, :S => 0.26, :metric_weight => 1.32999, :imperial_weight => 11.10)
