...
ten = Fertiliser.create(:name => "10-34-0", :N => 0.1, :P => 0.34, :liquid_weight => 1.389987)
seven = Fertiliser.create(:name => "7-21-7", :N => 0.07, :P => 0.21, :K => 0.07, :liquid_weight => 1.282143)
nine = Fertiliser.create(:name => "9-18-9", :N => 0.09, :P => 0.18, :K => 0.09, :liquid_weight => 1.318091)
three = Fertiliser.create(:name => "3-18-18", :N => 0.03, :P => 0.18, :K => 0.18, :liquid_weight => 1.401969)
four = Fertiliser.create(:name => "4-10-10", :N => 0.04, :P => 0.1, :K => 0.1, :liquid_weight => 1.282143)
